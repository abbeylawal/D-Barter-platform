...
contract TradeContract {
    ...
    event TradeCreated(uint id, uint nftId, address owner, address counterparty, string status);
    ...
    function createTrade(uint _nftId, address _counterparty) public {
        tradeCounter++;
        trades[tradeCounter] = Trade(tradeCounter, _nftId, msg.sender, _counterparty, "initiated");
        emit TradeCreated(tradeCounter, _nftId, msg.sender, _counterparty, "initiated");
    }
